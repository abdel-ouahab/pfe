			...
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-user">
					...
					<span class="username username-hide-on-mobile">
                                            <% out.print(session.getAttribute("nom")+" "+session.getAttribute("prenom"));%>
					</span>
	...
	<div class="page-sidebar-wrapper">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li class="start ">
					<a href="table_dept.jsp">
					<i class="fa fa-table"></i>
					<span class="title">LISTE DÉPARTEMENTS</span>
					</a>	
				</li>
				<li>
					<a href="javascript:;">
                                            ...
                                            <%
                                                ...
                                                try {
                                                        ...
                                                        while(rs.next()){
                                                                %>  
                                                        <li>
                                                        	<a href="../Admin_dept/index.jsp?id_dept=<%=rs.getString(1)%>"><%=rs.getString(3)%></a>
                                                        </li>
                                            <%}}catch(Exception e) {
                                                System.out.print(e);
                                                out.print(e);
 ...
 <div class="modal-dialog">
  <div class="modal-content">
   ...
   <div class="modal-body">
    ...
    <br />
    <label>Type : <% out.print(session.getAttribute("admin")+" principal");%> </label>
    <br />
