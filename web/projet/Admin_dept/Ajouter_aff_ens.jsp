<%-- 
    Document   : Ajouter_aff_ens
    Created on : Dec 30, 2023, 5:16:38 PM
    Author     : Abd Elouahab
--%>
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<%if (session.getAttribute("admin_p") != null) { %>
						<a href="affectation_enseignant.jsp?id_dept=<%=id_dept%>">Affectation les modules par enseignant</a>
						<% } %>
                                                <%if (session.getAttribute("admin_p") == null) {%>
						<a href="affectation_enseignant.jsp">Affectation les modules par enseignant</a>
						<% } %>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>Affectation les modules par enseignant
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							...
							<form action="../../Ajouter_prog1?id_dept=<%=id_dept%>" class="form-horizontal form-row-sepe" method="POST">
								<div class="form-body">
									
											<div class="form-group">
											<label class="control-label col-md-3">Ensiegnant</label>
											<div class="col-md-6">
												<div class="input-group">
													<span class="input-group-addon">
													<i class="fa fa-user"></i>
													</span>
													<select name="ens" class="form-control select2me" data-placeholder="choisir Ensiegnant" required>
													<option></option>
													<%
                                                                                                            ...
                                                                                                            try {
                                                                                                                ...
                                                                                                                String query = "SELECT * FROM enseignant WHERE id_dept=?";
												...
												<div class="input-group">
													...
													<%
                                                                                                            ...
                                                                                                            try {
                                                                                                                ...
                                                                                                                if (rs != null) {
                                                                                                                    while (rs.next()) {
                                                                                                                        int id = rs.getInt("id_niv");
                                                                                                                        String nom_niv = rs.getString("nom_niv");
                                                                                                        %>
                                                                                                                        <option value="<%= id %>"><%= nom_niv %></option>
                                                                                                        <%
                                                                                                                    }
                                                                                                                }
                                                                                                            } catch (Exception e) {
...
var id = this.value;
			$('#Section').load( "ajax/get_sec.jsp?id="+id, function() {
});	
